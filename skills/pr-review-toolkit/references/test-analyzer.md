...
- Check for project-specific testing standards in project guidelines (e.g., CLAUDE.md)
...
Be thorough but pragmatic — focus on tests that provide real value in catching bugs and preventing regressions rather than achieving metrics.
